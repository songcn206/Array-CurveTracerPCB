...
U 1 1 5C25CF4C
P 7950 1500
F 0 "#PWR011" H 7950 1350 50  0001 C CNN
...
U 1 1 5C336510
P 9100 3200
F 0 "#PWR015" H 9100 2950 50  0001 C CNN
...
U 1 1 5C3F3A77
P 10850 2700
F 0 "J3" H 11050 2600 50  0000 R CNN
...
U 1 1 5C410349
P 10550 3000
F 0 "#PWR017" H 10550 2750 50  0001 C CNN
...
$Sheet
S 1000 6000 1000 400 
U 5C392C6A
F0 "LEDs" 50
F1 "LEDs.sch" 50
F2 "PC[0..5]" I R 2000 6100 50 
F3 "PA[5..7]" I R 2000 6200 50 
F4 "RUN" I R 2000 6300 50 
$EndSheet
...
F 1 "M.3" H 10400 3905 50  0000 L CNN
...
F 1 "M.3" H 10400 4155 50  0000 L CNN
...
F 1 "M.3" H 10400 4405 50  0000 L CNN
...
F 1 "M.3" H 10400 4655 50  0000 L CNN
...
U 1 1 5D8871C1
P 10550 2500
F 0 "#PWR016" H 10550 2350 50  0001 C CNN
...
PD2
$Sheet
S 1000 3500 1000 1000
U 5D766247
F0 "Sensor Boards Interface" 50
F1 "SensorBrdInterface.sch" 50
F2 "V_MOSI" I R 2000 3700 50 
F3 "V_MISO" O R 2000 3800 50 
F4 "V_CLK" I R 2000 3600 50 
F5 "V_CS" I R 2000 3900 50 
F6 "I_MOSI" I R 2000 4200 50 
F7 "I_MISO" O R 2000 4300 50 
F8 "I_CLK" I R 2000 4100 50 
F9 "I_CS" I R 2000 4400 50 
$EndSheet
$Sheet
...
$EndSheet
$Sheet
S 1000 4800 1000 400 
U 5D923D59
F0 "Error Light" 50
F1 "ErrorLight.sch" 50
F2 "FAULT" I R 2000 4900 50 
$EndSheet
$Sheet
S 1000 5450 1000 300 
U 5D99F192
F0 "USB" 50
F1 "USB.sch" 50
F2 "UART_RX" I R 2000 5550 50 
F3 "UART_TX" O R 2000 5650 50 
$EndSheet
...
U 1 1 5D8E306E
P 7800 5100
F 0 "#PWR09" H 7800 4850 50  0001 C CNN
...
U 1 1 5D9A509E
P 8500 5750
F 0 "J2" H 8580 5792 50  0000 L CNN
...
U 1 1 5E2EFB22
P 8500 5200
F 0 "J1" H 8580 5192 50  0000 L CNN
...
F2 "PWM1" I R 2000 6800 50 
F3 "PWM2" I R 2000 6900 50 
F4 "PWM3" I R 2000 7000 50 
F5 "PWM4" I R 2000 7100 50 
$EndSheet
Wire Wire Line
	5100 5000 4600 5000
Wire Wire Line
